                           ...
                           _Args&&... __args)
{
  ...
  if constexpr (::cuda::std::
                  is_invocable_v<_Kernel, kernel_config<_Dimensions, _Config...>, device_transform_result_t<_Args>...>)
  {
    auto __launcher = __kernel_launcher<decltype(__combined), _Kernel, device_transform_result_t<_Args>...>;
  ...
  {
    static_assert(::cuda::std::is_invocable_v<_Kernel, device_transform_result_t<_Args>...>);
    auto __launcher = __kernel_launcher_no_config<_Kernel, device_transform_result_t<_Args>...>;
    return __launch_impl(
      __forward_or_cast_to_stream_ref<_Submitter>(_CUDA_VSTD::forward<_Submitter>(__submitter)),
      __combined,
      reinterpret_cast<void*>(__launcher),
