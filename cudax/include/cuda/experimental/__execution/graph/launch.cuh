...
struct graph_domain::__apply_t<__kernel_t>
{
  struct __fn
  {
    ...
    _CCCL_HOST_API auto operator()(_Context& __context, _Config __config, _Fn __fn, _Args... __args) -> __visit_result_t
    {
      ...
      auto* __launcher = &detail::kernel_launcher<_Config, _Fn, _Args...>;
      ...
      void* __as[] = {_CUDA_VSTD::addressof(__config), _CUDA_VSTD::addressof(__fn), _CUDA_VSTD::addressof(__args)...};
      ...
      _CCCL_TRY_CUDA_API(detail::apply_kernel_config, "kernel configuration failed", __config, __launch_config, __pfn);
