...
struct _CCCL_TYPE_VISIBILITY_DEFAULT graph_context : private __immovable
{
  ...
  struct __sndr_t
  {
    ...
    {
      return __env_t{__context_};
    }

    _CCCL_NO_UNIQUE_ADDRESS scheduler_sender_t __tag_;
    graph_context* __context_;
  };
...
template <>
struct _CCCL_TYPE_VISIBILITY_DEFAULT graph_domain::__apply_t<graph_context::scheduler_sender_t>
{
