...
#ifndef __CUDAX_EXECUTION_STORAGE_REGISTRY
#define __CUDAX_EXECUTION_STORAGE_REGISTRY
...
struct __storage_registry_context
{
  ...
  _CCCL_HOST_API auto __finalize() -> __storage_registry
  {
    ...
    __buffer_ = __storage_registry_buffer_t{__mr, cuda::get_stream(__buffer_), __host_descriptors_.back().__offset_};
...
#endif // __CUDAX_EXECUTION_STORAGE_REGISTRY
