...
template <class _Tp>
_CCCL_NODISCARD _CUDAX_HOST_API inline constexpr auto __is_small(size_t __size, size_t __align) noexcept -> bool
{
...
_CCCL_NODISCARD _CUDAX_TRIVIAL_HOST_API auto __ptr_eq(_Tp* __lhs, _Up* __rhs) noexcept -> bool
{
