...
private:
  ...
  cuda_async_transform(::cuda::stream_ref, uninitialized_async_buffer& __self) noexcept
  ...
  template <class _Tp2 = _Tp>
  _CCCL_NODISCARD_FRIEND _CCCL_HIDE_FROM_ABI auto
  cuda_async_transform(::cuda::stream_ref, const uninitialized_async_buffer& __self) noexcept
