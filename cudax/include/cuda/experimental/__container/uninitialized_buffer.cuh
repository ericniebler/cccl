...
private:
  ...
  cuda_device_transform(::cuda::stream_ref, uninitialized_buffer& __self) noexcept
  ...
  template <class _Tp2 = _Tp>
  [[nodiscard]] _CCCL_HIDE_FROM_ABI friend auto
  cuda_device_transform(::cuda::stream_ref, const uninitialized_buffer& __self) noexcept
