...
public:
  ...
  [[nodiscard]] _CCCL_HIDE_FROM_ABI friend auto cuda_device_transform(::cuda::stream_ref, async_buffer& __self) noexcept
  ...
  cuda_device_transform(::cuda::stream_ref, const async_buffer& __self) noexcept
