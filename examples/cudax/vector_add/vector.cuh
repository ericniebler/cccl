...
private:
  ...
  cuda_device_transform(::cuda::stream_ref __str, vector& __v) noexcept
  {
    return __action<__detail::__param_kind::_inout>{__str, __v};
  }

  [[nodiscard]] friend __action<__detail::__param_kind::_in>
  cuda_device_transform(::cuda::stream_ref __str, const vector& __v) noexcept
  {
  ...
  cuda_device_transform(::cuda::stream_ref __str, __detail::__box<vector, _Kind> __b) noexcept
  {
